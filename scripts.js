...
function populateGrid(){
    ...
    if (myLibrary.length == 1 ){ //if theres only one book in the library, make a card
        makeCard(myLibrary[0]);
    }
    else{
        for(let i = myLibrary.length;i>0;i--){ //this shows the most recent book entered at the top
